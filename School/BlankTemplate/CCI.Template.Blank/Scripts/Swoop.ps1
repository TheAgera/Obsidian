...
<svg xmlns="http://www.w3.org/2000/svg" width="12in" height="8in">
  <g
    ...
    <text font-family="Noto Sans JP Regular" font-size="98pt" fill="black" text-anchor="left" letter-spacing="4px">
        <tspan x=".5in" y="1.75in">$First</tspan>
        <tspan x=".5in" dy="1.5in">$Last</tspan>
    </text>
    <text font-family="Noto Sans JP Regular" font-spacing="4px" font-size="98pt" fill="black" text-anchor="left" letter-spacing="4px">
        <tspan x=".5in" y="5.75in">$First</tspan>
        <tspan x=".5in" dy="1.5in">$Last</tspan>
    </text>
    <text font-family="Noto Sans JP Regular" font-size="98pt" fill="black" text-anchor="left" letter-spacing="4px">
        <tspan x=".5in" y="9.75in">$First</tspan>
        <tspan x=".5in" dy="1.5in">$Last</tspan>
    </text>
    </g>
</svg>
...
$svgContent | Out-File -FilePath "c:\users\$env:USERNAME\desktop\$First,Swoop.svg"

# Define file paths
$inkscapePath = 'C:\Program Files\Inkscape\bin\inkscape.com'
$inputFilePath = "C:\Users\$env:USERNAME\Desktop\Swoop.svg"
$outputFilePath = "C:\Users\$env:USERNAME\Desktop\Swoop_Path.svg"
